+++
title = "Unity Physics 学习笔记 第六章 触发器事件与碰撞事件"
...
新建一个 Cube 的 GameObject，移除 Box Collider，添加 Convert To Entity，Physics Body，Physics Shape。在 Physics Body 中把重力系数设为 0，在 Physics Shape 中勾选 Is Trigger  
